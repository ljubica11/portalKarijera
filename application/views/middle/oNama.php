...
<body>
    <div class="container-fluid" id="oNama">
        ...
        <div class="row">
            ...
            <div class="col-sm-4"><img src="http://localhost/portalKarijera//images/ljuba.jpg"
                    style="height: 40%; width: 50%; border-style: double;"></div>
            <div class="col-sm-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-4"><img src="http://localhost/portalKarijera//images/gogi.jpg"
                    style="height: 40%; width: 50%; border-style: double;"></div>
            <div class="col-sm-3">
                <p></p>
        ...
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-4"><img src="http://localhost/portalKarijera//images/zoka.jpg"
                    style="height: 40%; width: 60%; border-style: double;"></div>
            <div class="col-sm-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-4"><img src="http://localhost/portalKarijera//images/sasa.jpg"
                    style="height: 40%; width: 80%; border-style: double;"></div>
            <div class="col-sm-3">
                <p></p>
        ...
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-4"><img src="http://localhost/portalKarijera//images/sanja.jpg"
                    style="height: 40%; width: 50%; border-style: double;"></div>
            <div class="col-sm-4">
