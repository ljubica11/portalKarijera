...
<div class="container" id="container3">
    ...
    <div class="row" id="iskustva">
        <div class="col-1">
            <img src="<?php echo base_url() ?>/images/tamara_1.jpg" class="img-fluid img-korisnici">
        </div>
        <div class="col-5">
            <b>Tamara Antonijević:</b> "Prolazak kroz IT preobuku i pronalaženje ovog portala me je izbavilo tmurne budućnosti u trafici na okretnici u Žarkovu, u kojoj sam godinama pre toga radila . Danas imam sjajan posao, sve zahvaljujući portalu Karijera!"
        </div>

        <div class="col-1">
            <img src="<?php echo base_url() ?>/images/jovan_1.jpg" class="img-fluid img-korisnici">
        </div>
        <div class="col-5">
            <b>Jovan Marić:</b> "Moj život se u potpunosti promenio od kad sam prvi put došao na ovaj sajt. Za početak, više ne moram da ustajem u četiri ujutro svakog dana, jer sam zahvaljujući kontaktima sa portala Karijera konačno dao otkaz u pekari i našao dobar posao."
        </div>
    </div>
</div>
...
<script>
    ...
    var title = ['<p><u><b>Najnovija vest:</b></u><br>  <?php foreach ($vest as $v) {
    echo ($v['tekst']);
} ?></p>',
        '<p><u><b>Najnovije obavestenje:</b></u><br>  <?php foreach ($obavestenje as $ob) {
    echo ($ob['tekst']);
} ?></p>',
        '<p><u><b>Najnoviji oglas:</b></u><br> <?php foreach ($oglas as $og) {
    echo ($og['opis']);
} ?></p>',
        '<p><u><b>Najnovija diskusija:</b></u><br> <?php foreach ($diskusija as $d) {
    echo ($d['opis']);
} ?></p>'];
    var index = 0;
