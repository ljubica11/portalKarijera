...
<div class="container" id="container1">
    ...
    <div class="row">
        <form class="offset-sm-1 form-inline my-2 my-lg-0" name="loginForma" method="POST"
            action="<?php echo base_url()?>index.php/registracija">
                ...
                <div class="form-row">
                    <div class="col-8 offset-2">
                        <input class="form-control" type="text" name="username"
                            value="<?php echo $this->session->flashdata('login_username')?>">
                        <br />
                        <input class="form-control" type="password" placeholder="Lozinka" name="pass">
                        <small><a
                                href="<?php echo site_url('Reset_lozinke')?>">Zaboravili
                                ste lozinku?</a></small>
...
<script>
    var title = [
        '<p><u><b>Najnovija vest:</b></u><br>  <?php foreach ($vest as $v) {
    echo($v['tekst']);
} ?></p>',
