...
<?php
if ($this->session->flashdata('obavestenjePostavljeno')) {
...
<script>
    /**
     * Funkcija za omogucavanje opadajucih lista kurseva i grupa
     * Reaguje u zavisnosti od toga da li je odabrana opcija kurs/grupa
     * @returns {undefined}
     */
    function omoguci() {
...
<?php } ?>
    ...
    /**
     * Ajax-funkcija za ispisivanje obavestenje
     * Reaguje na odabir naslova obavestenja u vidu linka
     * @param int id
     * @returns {undefined}
     */
