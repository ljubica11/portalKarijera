...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="<?php echo site_url('Login')?>"><img id="brand-image" src="../images/logo.png" width="90" height="60" title="Logo" alt="Logo" />Portal Karijera</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto">
                ...
                <form class="form-inline my-2 my-lg-0" name="loginForma" method="POST" action="<?php echo site_url('Login/logovanje')?>">
                    ...
                    <input class="form-control mr-sm-2" type="text" name="pass">
